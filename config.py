...
OAUTH_PROVIDERS = [
    # {
    #     'name': 'azure',  # The name of the OAuth provider, used in set_oauth_session
    #     'token_key': 'acces-token',  # The key in the OAuth response containing the access token
    #     'icon': 'fa-windows',  # Optional icon for the login page
    #     'remote_app': {
    #         'client_id': 'ac86ce12-33bf-4708-8f1c-248184c935e2',
    #         'client_secret': 'ebS8Q~gg3EGsYsBzY6GyTR.h5AsaymtDDr6Via15',
    #         'token_endpoint_params': {'resource': '693ed5a4-aca9-44c1-a9be-ae17e6b50e7e', 'scope':"User.read name preferred_username email profile upn"},
    #         'base_url': 'https://login.microsoftonline.com/693ed5a4-aca9-44c1-a9be-ae17e6b50e7e/',
    #         'request_token_params': {'resource': '693ed5a4-aca9-44c1-a9be-ae17e6b50e7e'},
...
#         "client_id": "ac86ce12-33bf-4708-8f1c-248184c935e2",
#         "client_secret": "ebS8Q~gg3EGsYsBzY6GyTR.h5AsaymtDDr6Via15",
#         "api_base_url": "https://login.microsoftonline.com/693ed5a4-aca9-44c1-a9be-ae17e6b50e7e/v2.0",
#         "client_kwargs": {
...
#         "access_token_url": "https://login.microsoftonline.com/693ed5a4-aca9-44c1-a9be-ae17e6b50e7e/oauth2/v2.0/token",
#         "authorize_url": "https://login.microsoftonline.com/693ed5a4-aca9-44c1-a9be-ae17e6b50e7e/oauth2/v2.0/authorize",
#       }
#       },
    # {
    #     "name": "azure",
    ...
    #         "client_kwargs": {
    #             "scope": "User.ReadBasic.All name preferred_username email profile upn",
    #             "resource": "693ed5a4-aca9-44c1-a9be-ae17e6b50e7e",
    #         },
    #         "request_token_url": None,
    #         "access_token_url": "https://login.microsoftonline.com/693ed5a4-aca9-44c1-a9be-ae17e6b50e7e/oauth2/token",
    #         "authorize_url": "https://login.microsoftonline.com/693ed5a4-aca9-44c1-a9be-ae17e6b50e7e/oauth2/authorize",
...
OAUTH_PROVIDERS = [
    {'name':'twitter', 'icon':'fa-twitter',
        ...
        'remote_app': {
            'client_id':'RWh1bzlZV09hVjMweGpRRXV5c3M6MTpjaQ',
            'client_secret':'PJ7f4GsrKeMTA-cejwCconV1zyhbhWEIz73DoYK3ZWYHeVoKwb',
...
CLIENT_ID = "ac86ce12-33bf-4708-8f1c-248184c935e2" # Application (client) ID of app registration

CLIENT_SECRET = "ebS8Q~gg3EGsYsBzY6GyTR.h5AsaymtDDr6Via15" # Placeholder - for use ONLY during testing.
...
AUTHORITY = "https://login.microsoftonline.com/693ed5a4-aca9-44c1-a9be-ae17e6b50e7e"  # For multi-tenant app
...
# # Your App secret key
# SECRET_KEY = "60bc9577d689253716d045cf58b23fef"
...
# {'token_type': 'Bearer', 'scope': 'offline_access openid profile User.ReadBasic.All', 'expires_in': '4619', 'ext_expires_in': '4619', 'expires_on': '1689941253', 'not_before': '1689936333', 'resource': '00000002-0000-0000-c000-000000000000', 'access_token': 'eyJ0eXAiOiJKV1QiLCJhbGciOiJSUzI1NiIsIng1dCI6Ii1LSTNROW5OUjdiUm9meG1lWm9YcWJIWkdldyIsImtpZCI6Ii1LSTNROW5OUjdiUm9meG1lWm9YcWJIWkdldyJ9..JcFv4SXmnFx-AwWIwcSmPprgMXNk253zzsZGflixe1lNP91i6mr6FtZ8wfDXdSwCV4PYfG7Azic0M55ZJSAT9jG9YZkQHmCF-tQEeT5v6g7s08iYkad46BZsK4Rrn19ucztx0ZSx7YSlIW5z5SCTlFmOwTzQQBCg_ogQHrIYe00YoZai6TQohrvYdY8R6YigPcBGV1LEi1ojZMy0v_t387I8JZ8VZVN8A